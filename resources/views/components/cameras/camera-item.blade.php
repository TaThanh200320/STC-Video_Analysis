    ...
    <div class="p-3">
        ...
        <div class="space-y-2 text-sm text-gray-600">
            ...
            <div class="flex items-center">
                ...
                @switch($camera->trangthai)
                    @case('1')
                        <span
                            class="inline-flex rounded-full px-2 text-xs font-semibold leading-5 bg-green-100 text-green-800">Run</span>
                    @break

                    @case('0')
                        <span
                            class="inline-flex rounded-full px-2 text-xs font-semibold leading-5 bg-red-100 text-red-800">Stop</span>
                    @break

                    @case('2')
                        <span
                            class="inline-flex rounded-full px-2 text-xs font-semibold leading-5 bg-yellow-100 text-yellow-800">Inactive</span>
                    @break

                    @case('3')
                        <span
                            class="inline-flex rounded-full px-2 text-xs font-semibold leading-5 bg-gray-100 text-gray-800">Active</span>
                    @break
